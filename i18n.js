...
const I18N = {
    ko: {
        ...
        rSumSub: "내신·SAT·영어·목표 조합에 따라 최적 경로가 달라집니다. 진단을 시작하면 아래 세 경로 중 내 상황에 맞는 루트를 추천해 드립니다.",
    ...
    satTypePrompt: '어느 시험인가요? 점수를 입력하시면 지원 가능 구간을 함께 알려드릴게요.',
    satSubmitBtn: '이 점수로 진행하기',
    satBandhigh: '최상위권 지원 가능',
    satBandmid: '중상위권 지원 가능',
    satBandlow: '점수 보완 권장',
    satBandMsg: (type, sc, band) => `${type} ${sc}점이면 <strong>${band}</strong> 구간입니다. 이 기준으로 분석을 진행할게요.`,
    ...
    en: {
        ...
        rSumSub: "The best route depends on your mix of grades, SAT, English and goals. Take the assessment and we'll point you to the one that fits.",
    ...
    satTypePrompt: "Which test was it? Enter the score and we'll tell you the band it puts you in.",
    satSubmitBtn: "Continue with this score",
    satBandhigh: "competitive for the most selective schools",
    satBandmid: "competitive for upper-tier schools",
    satBandlow: "worth improving before applying",
    satBandMsg: (type, sc, band) => `${type} ${sc} is <strong>${band}</strong>. We'll continue on that basis.`,
...
const DATA_EN = {
    ...
    'SAT나 ACT 점수가 있으신가요?<br><span class="block mt-3 text-[13px] text-gray-500 leading-relaxed">※ 2026-27 기준 아이비리그·MIT·스탠퍼드 등 최상위권은 SAT/ACT 필수입니다. 패스웨이·CC 편입은 필요하지 않습니다.</span>':
        'Do you have an SAT or ACT score?<br><span class="block mt-3 text-[13px] text-gray-500 leading-relaxed">For 2026-27 the most selective universities, the Ivy League, MIT and Stanford, require the SAT/ACT. Pathways and CC transfer do not.</span>',
    "네, 있습니다": "Yes, I have one",
